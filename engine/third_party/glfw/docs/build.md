...
```sh
gcc -o myprog myprog.c -I path/to/opengl/include path/to/opengl/lib-mingw-w64/libglfw3.a -lgdi32
```
...
```sh
gcc -o myprog myprog.c -I path/to/opengl/include path/to/opengl/lib-mingw-w64/libglfw3dll.a -lgdi32
```
...
```sh
gcc -o myprog myprog.c -D GLFW_DLL -I path/to/opengl/include path/to/opengl/lib-mingw-w64/libglfw3dll.a -lgdi32
```
...
```sh
env PKG_CONFIG_PATH=path/to/opengl/src cc $(pkg-config --cflags glfw3) -o myprog myprog.c $(pkg-config --libs glfw3)
```
