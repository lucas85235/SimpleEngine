...
```sh
cmake -S path/to/opengl -B path/to/build
```
...
```sh
cmake -S path/to/opengl -B path/to/build -G Xcode
```
...
```sh
cmake -S path/to/opengl -B path/to/build -D GLFW_BUILD_X11=0
```
...
```sh
cmake -S path/to/opengl -B path/to/build -D BUILD_SHARED_LIBS=ON
```
...
```sh
cmake -S path/to/opengl -B path/to/build -D CMAKE_TOOLCHAIN_FILE=path/to/file
```
...
```sh
cmake -S path/to/opengl -B path/to/build -D CMAKE_TOOLCHAIN_FILE=CMake/x86_64-w64-mingw32.cmake
```
